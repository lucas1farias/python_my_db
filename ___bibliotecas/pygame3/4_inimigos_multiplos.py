...
import pygame
from random import choice, random  # TODO: Importação necessária
...
# TODO: Vars para subjetificar a velocidade vertical e tamanho dos inimigos
...
# TODO: Porque a classe já recebe os sprites preparados? Por existir variações do inimigo
class Enemy:
    ...
    # TODO: Porque aqui? Para evitar muitos códigos dentro da função __init__
    ...
    def __init__(self, enemy_name, enemy_width, enemy_height, random_location=False, location=0):
        ...
        # TODO: Lista que recebem dados dependendo do inimigo passado
        self.shell_purple_surfaces = []
        self.shell_green_surfaces = []
        self.shell_purple_rectangles = []
        self.shell_green_rectangles = []

        # TODO: Vars para carregar no canvas
        self.image = None
        self.image_rect = None

        self.shell_locations_x = [*range(700, 2001)]  # TODO: Var determinante da posição horizontal
        self.current_sprite = 0

        if enemy_name == 'shell_purple':
            # TODO: As superfícies são criadas primeiro, pois não precisam informar "self.x" ou "self.y"
            Enemy.img_into_surface(self, 'shell_purple')

            # TODO: Deixar uma var escolher a posição horizontal
            ...
            # TODO: Criar um jogador numa posição horizontal controlada
            else:
                self.x = location
                Enemy.surface_into_rectangle(self, 'shell_purple')
                Enemy.set_main_surface_and_rectangle(self, 'shell_purple')
...
# TODO: Parâmetros para criar inimigos múltiplos
shell_types = ['shell_purple', 'shell_green']
shell_amount = 10
shell_box = []


# TODO: Porque essa função? Para criar inimigos, e está fora da classe, pois involve criação de objeto da classe
def make_enemy(enemy_type, enemy_object_box, end_point, enemy_type_box, location, x):
    counter = 0

    # TODO: Em locais não específicos
...
make_enemy('shell', shell_box, 1, shell_types, True, 400)  # TODO: Criação do inimigo com localização customizada


def exec_enemy_class_functions(which_enemy, enemy_box):
    if which_enemy == 'shell':
        # TODO: Configuração e exibição dos inimigos no canvas
...
while True:
    ...
    # TODO: Execução de uma função que executa funções de classe
